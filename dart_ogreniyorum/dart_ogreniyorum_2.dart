void main(List<String> args) {
  ...
  */
  ...
  ÖNEMLİ NOT:
  ------------------------------------------------------------------------------------------------------------
  Eğer print işlemi içerisinde matematiksel bir işlem yapmak istiyorsak, işlemi tırnak içine almamalıyız.
  Aksi takdirde, işlemi metin olarak algılar ve matematiksel işlem yapmaz. Bu nedenle, matematiksel işlemleri
  tırnak içine almadan yazmalıyız.
  ------------------------------------------------------------------------------------------------------------
   */
